        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/category') ? 'active':'' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'all.subsubcategories')?'active':'' }}"><a href="{{ route('all.subsubcategories') }}"><i class="ti-more"></i>All Sub->SubCategories</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ ($prefix == '/coupons') ? 'active':'' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'manage-coupon')?'active':'' }}"><a href="{{ route('manage-coupon') }}"><i class="ti-more"></i>Coupon Slider</a></li>

                </ul>
            </li>

            <li class="treeview {{ ($prefix == '/ship') ? 'active':'' }}">
                <a href="#">
                    <i data-feather="file"></i>
                    <span>Shipping areas</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-right pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'manage-ship')?'active':'' }}"><a href="{{ route('manage-ship') }}"><i class="ti-more"></i>Shipping Area</a></li>
