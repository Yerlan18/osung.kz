    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="item">
                            <div class="products">
                                <div class="hot-deal-wrapper">
                                    <div class="image"> <img src="{{ asset($hot->product_thumbnail) }} " alt=""> </div>
                                            ...
                                            <div class="row product-micro-row">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="#">{{ asset($product->product_name_en) }}</a></h3>
                                                        <div class="rating rateit-small"></div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a href="{{ url('product/details/'.$fea->id.'/'.$fea->product_slug_en) }}"><img src="{{ asset($fea->product_thumbnail) }}" alt=""></a> </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="{{ url('product/details/'.$fea->id.'/'.$fea->product_slug_en) }}">{{ $fea->product_name_en }}</a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                                        <div class="product-price"> <span class="price"> ${{$fea->selling_price}} </span> <span class="price-before-discount">${{$fea->discount_price}}</span> </div>
                                        <!-- /.product-price -->
                                    ...
                                    <div class="cart clearfix animate-effect">
                                        <div class="action">
                                            <ul class="list-unstyled">
                                                <li class="add-cart-button btn-group">
                                                    <button class="btn btn-primary icon" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" type="button" id="{{ $fea->id }}" onclick="productView(this.id)"> <i class="fa fa-shopping-cart"></i> </button>
                                                    <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                                                </li>
                                                <button class="btn btn-primary icon" type="button" title="Wishlist" onclick="WhishList(this.id)" id="{{ $fea->id }}"> <i class="icon fa fa-heart"></i> </button>
                ...
                <!-- ============================================== FEATURED PRODUCTS ============================================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">{{ $skip3_cat->category_name_en }}</h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        @foreach($skip3_product as $fea)
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
