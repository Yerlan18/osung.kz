                            ...
                            <div class="sidebar-widget-body">
                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading"> <a href="#collapseOne{{$category->id}}" data-toggle="collapse" class="accordion-toggle collapsed"> {{ $category->category_name_en }} </a> </div>
                                        <!-- /.accordion-heading -->
                                        ...
                                        <div class="accordion-body collapse" id="collapseOne{{$category->id}}" style="height: 0px;">
                                            <div class="accordion-inner">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{ url('subcategory/product/'.$sub->id.'/'.$sub->subcategory_slug_en) }}" style="padding:0;">{{ $sub->subcategory_name_en }}</a></li>
                                                    @endforeach
                                                </ul>
                                            ...
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en) }}">{{ asset($product->product_name_en) }}</a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"> <span class="price"> ${{ $product->selling_price }} </span> <span class="price-before-discount">${{ $product->discount_price }}</span> </div>
                                                        <!-- /.product-price -->
